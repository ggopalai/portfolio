            ...
            <main id={styles.content}>
                ...
                <section id={styles.intro}> 
                    ...
                    <intro-text id={styles.introtext}>
                        <p>Welcome to my website! I'm a graduate student at UC San Diego, currently pursuing a Master's degree in Computer Science with a specialization in Computer Systems. 
                           My primary areas of interest are Cloud Computing, Distributed Systems, and Computer Networks.</p>
                        ...
                        <p>Feel free to explore and get in touch with me for any further inquiries or opportunities. Thank you for visiting!</p>
                ...
                <section id={styles.industry}>
                    ...
                    <Card 
                        ...
                        exp={["Spearheaded the development of a web-application to remotely demo LitePoint's testers to potential customers.", 
                ...
                <section id={styles.teaching}>
                    ...
                    <Card 
                        ...
                        exp={["CSE 210 Principles of Software Engineering is a more focused and motivated version of CSE 110."]}
                        image="/logos/ucsd.png"
                        start="Sept 2023"
                        end="Dec 2023"/>
                    <Card 
                        ...
                        position="Graduate Teaching Assistant"
                        exp={["CSE 110 Software Engineering is a course that focuses on the software development lifecycle and the various tools and techniques used in the process. As a TA, I was responsible for mentoring a total of 11 teams (110 students in total) in their course projects.",
